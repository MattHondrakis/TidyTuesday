...
beecolony %>%
  ...
  ggplot(aes(months, n, fill = months)) + geom_col() + labs(y = "Average Percent of Colonies", title = "Percentage of Colonies Destroyed by Varroa mites") + theme(legend.position = "none")
